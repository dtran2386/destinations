...
module.exports = (function() {
    ...
    appDirectives.directive('nav', ['$compile', '$location', 'DestService', function($compile, $location, DestService) {
        return {
            restrict: 'A',
            scope: true,
            link: function (scope, element, attrs) {
